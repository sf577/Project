 ...
 * <p>
 * Usage: <code>java DtdDemo &lt;url&gt;</code>
 * <p>
 * Or, use it as an applet, supplying the URL as the <code>url</code> parameter.
 * <p>
 * Note: This does not preserve any processing instructions or parameter
 * entities in the DTD; otherwise, produces a fully expanded and normalised
 * version.
 * 
...
public class DtdDemo extends XmlApp {
	 ...
	 * Dump the DTD.
	 * <p>
	 * Once this event is received, we know that the DTD is completely parsed,
	 * and can use AElfred's query routines to reconstruct a normalised version
	 * of it.
	 * 
	 * @see #dumpNotations
	 * @see #dumpEntities
