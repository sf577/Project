 ...
 * <p>
 * This class fills in the basic interface, and provides an I/O infrastructure
 * for simple applications and applets.
 * 
...
public class XmlApplet extends Applet implements XmlHandler {
	 ...
	 * <p>
	 * This method could generate a new URL by looking up the public identifier
	 * in a hash table, or it could replace the URL supplied with a different,
	 * local one; for now, however, just return the URL supplied.
	 * 
	 ...
	 * <p>
	 * Do nothing for now. Subclasses can override this method if they want to
	 ...
	 * <p>
	 * The query methods in XmlParser will return useful values only after this
	 * callback.
	 * 
	 ...
	 * <p>
	 * Subclasses can override this method if they want to do something
	 * different.
	 * 
	 ...
	 * <p>
	 * This uses the old event model, so that it will work with existing
	 * browsers. It will cause a 'deprecated' warning when you compile.
	 */
	 ...
	 * <p>
	 * Erase the text area, then start the parser running, using the value of
	 * the "url" parameter.
	 */
