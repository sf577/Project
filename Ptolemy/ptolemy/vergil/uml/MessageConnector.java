 ...
 * diagram. It is used to draw a connection between two LifelineFigures and to
 * assign a name to the Message (through an attached label).
 * 
 * @author Andreas Thuy
 * 
...
public class MessageConnector extends StraightConnector {
	...
	/**
	 * This figure will be displayed on the screen. It represents the time when
	 * a message is sent.
	 */
	 ...
	 * and as a MessageConnector has an Arrowhead at the headSite, the Arrowhead
	 * will be painted in the color arrowColor.
	 * 
	 * @param tail
	 *            - Site that represents the starting point
	 * @param head
	 *            - Site that represents the end point
	 * @param layer
	 *            - layer of this figure
	 * @param arrowColor
	 ...
	 * 
	 * @param label
	 *            - label that will be displayed on the screen
	 */
	...
	public void setStartPoint(double startPoint) {
		...
		if (this.getTailSite().getX() <= this.getHeadSite().getX()) {
			this.startLabel.translateTo(this.getTailSite().getX() - 10, this
					.getTailSite().getY() - 5);
		} else {
			this.startLabel.translateTo(this.getTailSite().getX() + 10, this
					.getTailSite().getY() - 5);
