...
public class MessageOccurrenceSpecification extends MessageEnd implements
	 ...
	 * 
	 * @param msgOccSpec
	 *            - the msgOccSpec that is compared with this
	...
	public int compareTo(Object msgOccSpec) {
		if (msgOccSpec instanceof MessageOccurrenceSpecification) {
			MessageOccurrenceSpecification mOS = (MessageOccurrenceSpecification) msgOccSpec;
			// time stamp of this
	 ...
	 * 
	 * this is not so cool... an event may not contain specific information at
	 * the moment... that's bad for future versions...
	 */
	...
	/**
	 * @param messsageEvent
	 *            - the kind of event - either SendEvent or ReceiveEvent
	 */
	...
	/**
	 * @param lifeline
	 *            - the Lifeline that contains this MsgOccSpec
	 */
	...
	/**
	 * @param locTime
	 *            - position of the MsgOccSpec, second value depicts the time on
	 *            the time line
	 */
	...
	public void setTime(double time) {
		String locString = "<property name=\"location\" class="
