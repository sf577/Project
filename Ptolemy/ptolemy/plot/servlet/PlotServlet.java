...
/**
 * Takes the parameters file, w, h and returs and jpeg image with the ptplot
 * graph generated from the PlotML file.
 * 
 * the file mustbe located in the same directory or a subdirectory of the
 * servlet.
 * 
 * Use in your html as: &lt;img
 * src="/servlet/ptolemy/plot/servlet/PlotServlet?file=Bin.xml&w=500&h=500"/&gt;
 * &lt;img src=
 * "/servlet/ptolemy/plot/servlet/PlotServlet?file=HighLowSmall.xml&w=500&h=500"
 * /&gt;
 * 
...
public class PlotServlet extends HttpServlet {
	 ...
	 * {@link JPanel#addNotify} and {@link JPanel#doLayout}. If the server is
	 * running on Unix you will need to use java 1.4 and specify
	 * -Djava.awt.headless=true on the command Line or for tomcat: edit
	 * catalina.sh in the $CATALINA_HOME/bin directory and add a line
