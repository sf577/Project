...
public class PowerRouter {
	...
	public void setEast(double i) {
		ae = i;
	}

	public void setWest(double i) {
		aw = i;
	}

	public void setNorth(double i) {
		an = i;
	}

	public void setSouth(double i) {
		as = i;
	}

	public void setLocal(double i) {
		alocal = i;
	}

	public void setMaxBufferSize(double i) {
		max = i;
	}
