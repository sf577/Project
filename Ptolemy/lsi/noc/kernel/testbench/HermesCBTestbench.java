...
public class HermesCBTestbench extends Thread {
	...
	public void report() {
		...
		for (int i = 0; i < flows.size(); i++) {
			...
			System.out.println("Flow: " + i + " .... Direct Interference: "
					+ dir + " .... Indirect Interference: " + indir
					+ " .... Basic Latency: " + latency + " .... WC Latency: "
					+ wclatency + " .... Indirect WC Latency: " + iwclatency);
	...
	public void createRandomFlows(int n) {
		...
		// creates i traffic flows with randomly generated sources and
		// destinations
