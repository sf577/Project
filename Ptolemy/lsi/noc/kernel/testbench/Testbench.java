...
public class Testbench extends Thread {
	...
	public void displayApplicationGraph(String title) {
		...
		BasicVisualizationServer<Task, String> vv = new BasicVisualizationServer<Task, String>(
				layout);
		vv.setPreferredSize(new Dimension(1850, 950)); // Sets the viewing area
														// size
	...
	public void report() {
		...
		for (int i = 0; i < app.getTasks().size(); i++) {
			...
			System.out.println(i + "," + name + "," + corecode + "," + wcet
