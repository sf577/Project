...
public class PriorityApplicationModel extends lsi.noc.kernel.ApplicationModel {
	...
	/**
	 * Checks whether a given task is part of a group. If true, it adds the task
	 * to that group.
	 * 
	 * @param source
	...
	/**
	 * Returns the communication flow which is a response to a given
	 * communication flow (the request). A response is a flow sent back by a
	 * task which depends on the requesting task.
	 * 
	 * Returns <i>null</i> if there is no response to the request in question.
	 * 
	 * @param request
	 *            The communication flow containing the request in question.
	 */
