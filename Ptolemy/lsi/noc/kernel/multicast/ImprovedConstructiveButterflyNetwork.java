...
public class ImprovedConstructiveButterflyNetwork extends ButterflyNetwork {

	public ImprovedConstructiveButterflyNetwork(Point s1, Point s2, Point d1,
			Point d2) {
	...
	public void defineIntermediates() {
		...
		while (!iS1.equals(iS2) | !iD1.equals(iD2)) {
			...
			iSt = getFlooredMidpoint(iS1, iS2);
			iDt = getFlooredMidpoint(iD1, iD2);
